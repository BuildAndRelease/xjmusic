...
import 'package:xj_music/host_list/data_model/get_diss_song_response_model.dart';
...
class CloudMusicDissSongListPage extends StatefulWidget {
  final String dissId;
  final String dissName;
  final String dissInfo;
  final String dissPic;
  const CloudMusicDissSongListPage(
      this.dissId, this.dissName, this.dissInfo, this.dissPic);
  @override
  _CloudMusicDissSongListPageState createState() =>
      _CloudMusicDissSongListPageState();
}

class _CloudMusicDissSongListPageState
    extends State<CloudMusicDissSongListPage> {
  GetDissSongResponseModel _musicListModel;
  ...
  Widget build(BuildContext context) {
    return MusicUIFrame(
        headTitle: "歌手",
        title: widget.dissName,
        subTitle: widget.dissInfo,
        playBtnEnable: true,
        refreshEnable: true,
