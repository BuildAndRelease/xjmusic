...
import 'package:xj_music/host_list/data_model/get_top_list_song_response_model.dart';
...
class CloudMusicTopSongListPage extends StatefulWidget {
  final String topListDate;
  final String topListId;
  final String topName;
  final String topPic;

  const CloudMusicTopSongListPage(
      this.topListDate, this.topListId, this.topName, this.topPic);
  @override
  _CloudMusicTopSongListPageState createState() =>
      _CloudMusicTopSongListPageState();
}

class _CloudMusicTopSongListPageState extends State<CloudMusicTopSongListPage> {
  GetTopListSongResponseModel _musicListModel;
  ...
  Widget build(BuildContext context) {
    return MusicUIFrame(
        headTitle: "榜单",
        title: widget.topName,
        subTitle: widget.topListDate,
        playBtnEnable: true,
        refreshEnable: true,
  ...
  void _onRefresh() {
    HostApi.getTopListSong(
      widget.topListDate,
      widget.topListId,
      onError: (error) {
        showToast("获取榜单歌曲列表失败");
